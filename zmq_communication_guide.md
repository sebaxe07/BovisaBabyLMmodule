...
- **HumanDetection**: (`192.168.138.102`) - Computer vision and tracking functionality
- **LocalizationModule**: (`192.168.138.45`) - Localization and control functions
...
| ------------------ | ------------------ | ----------------------- | --------------- |
| HumanDetection     | LocalizationModule | tcp://192.168.138.102:5558 | Tracking data   |
| HumanDetection     | Any subscriber     | tcp://192.168.138.102:5559 | Video stream    |
| LocalizationModule | HumanDetection     | tcp://192.168.138.45:5557 | Camera commands |
...
camera_subscriber.connect("tcp://192.168.138.102:5558")
...
publisher.bind("tcp://192.168.138.102:5558")
...
camera_command_publisher.bind("tcp://192.168.138.45:5557")
...
video_publisher.bind("tcp://192.168.138.102:5559")
...
video_subscriber.connect("tcp://192.168.138.102:5559")
